...
<body><div class="topbar"><h1>fixbug</h1><span class="sub">Risk dashboard</span><button class="refresh" onclick="location.reload()">Refresh</button></div>
